...
fetchQuizQuestionsUrl quizID =
    "/rest/quiz_questions?select=id,body,slug,multiple_correct,options:quiz_question_options!quiz_question_option_quiz_question_id_fkey(id,body)&quiz_id=eq." ++ String.fromInt quizID

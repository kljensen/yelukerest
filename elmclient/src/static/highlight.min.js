...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("elm",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}],illegal:/;/}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){

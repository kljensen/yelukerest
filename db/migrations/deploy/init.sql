...
ALTER TABLE ONLY data.assignment_field_submission
    ADD CONSTRAINT assignment_field_submission_assignment_field_slug_fkey FOREIGN KEY (assignment_field_slug, assignment_slug) REFERENCES data.assignment_field(slug, assignment_slug) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_field_submission
    ADD CONSTRAINT assignment_field_submission_assignment_submission_id_fkey FOREIGN KEY (assignment_submission_id, assignment_slug) REFERENCES data.assignment_submission(id, assignment_slug) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_field_submission
    ADD CONSTRAINT assignment_field_submission_submitter_user_id_fkey FOREIGN KEY (submitter_user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_grade
    ADD CONSTRAINT assignment_grade_assignment_slug_fkey FOREIGN KEY (assignment_slug, points_possible) REFERENCES data.assignment(slug, points_possible) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_grade
    ADD CONSTRAINT assignment_grade_assignment_submission_id_fkey FOREIGN KEY (assignment_submission_id, assignment_slug) REFERENCES data.assignment_submission(id, assignment_slug) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_grade_exception
    ADD CONSTRAINT assignment_grade_exception_assignment_slug_fkey FOREIGN KEY (assignment_slug, is_team) REFERENCES data.assignment(slug, is_team) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_grade_exception
    ADD CONSTRAINT assignment_grade_exception_team_nickname_fkey FOREIGN KEY (team_nickname) REFERENCES data.team(nickname) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_grade_exception
    ADD CONSTRAINT assignment_grade_exception_user_id_fkey FOREIGN KEY (user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_submission
    ADD CONSTRAINT assignment_submission_submitter_user_id_fkey FOREIGN KEY (submitter_user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_submission
    ADD CONSTRAINT assignment_submission_team_nickname_fkey FOREIGN KEY (team_nickname) REFERENCES data.team(nickname) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.assignment_submission
    ADD CONSTRAINT assignment_submission_user_id_fkey FOREIGN KEY (user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.engagement
    ADD CONSTRAINT engagement_meeting_slug_fkey FOREIGN KEY (meeting_slug) REFERENCES data.meeting(slug) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_answer
    ADD CONSTRAINT quiz_answer_quiz_id_fkey FOREIGN KEY (quiz_id, user_id) REFERENCES data.quiz_submission(quiz_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_answer
    ADD CONSTRAINT quiz_answer_quiz_question_option_id_fkey FOREIGN KEY (quiz_question_option_id, quiz_id) REFERENCES data.quiz_question_option(id, quiz_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_grade_exception
    ADD CONSTRAINT quiz_grade_exception_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES data.quiz(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_grade_exception
    ADD CONSTRAINT quiz_grade_exception_user_id_fkey FOREIGN KEY (user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_grade
    ADD CONSTRAINT quiz_grade_quiz_id_fkey FOREIGN KEY (quiz_id, points_possible) REFERENCES data.quiz(id, points_possible) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_grade
    ADD CONSTRAINT quiz_grade_quiz_id_fkey1 FOREIGN KEY (quiz_id, user_id) REFERENCES data.quiz_submission(quiz_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_grade
    ADD CONSTRAINT quiz_grade_user_id_fkey FOREIGN KEY (user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz
    ADD CONSTRAINT quiz_meeting_slug_fkey FOREIGN KEY (meeting_slug) REFERENCES data.meeting(slug) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_submission
    ADD CONSTRAINT quiz_submission_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES data.quiz(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY data.quiz_submission
    ADD CONSTRAINT quiz_submission_user_id_fkey FOREIGN KEY (user_id) REFERENCES data."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY todo_access_policy ON data.todo TO api USING ((((request.user_role() = 'student'::text) AND (request.user_id() = owner_id)) OR (private = false))) WITH CHECK (((request.user_role() = 'student'::text) AND (request.user_id() = owner_id)));
...
CREATE POLICY user_access_policy ON data."user" TO api USING ((((request.user_role() = 'student'::text) AND (request.user_id() = id)) OR ((request.user_role() = ANY ('{faculty,ta}'::text[])) OR (CURRENT_USER = 'authapp'::name))));
...
GRANT SELECT ON TABLE api.users TO authapp;
...
GRANT USAGE ON SEQUENCE data.todo_id_seq TO student;

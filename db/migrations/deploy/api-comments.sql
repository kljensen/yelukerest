COMMENT ON COLUMN api.meetings.title IS
    'Human-readable title for the meeting';

COMMENT ON VIEW api.artifacts IS
...
COMMENT ON VIEW api.assignments IS
...
COMMENT ON VIEW api.assignment_fields IS
...
COMMENT ON VIEW api.assignment_submissions IS
...
COMMENT ON VIEW api.assignment_grades IS
...
COMMENT ON VIEW api.assignment_grade_events IS
...
COMMENT ON VIEW api.assignment_grade_exceptions IS
...
COMMENT ON VIEW api.engagements IS
...
COMMENT ON VIEW api.grade_events IS
...
COMMENT ON VIEW api.quizzes IS
...
COMMENT ON VIEW api.quiz_submissions IS
...
COMMENT ON VIEW api.quiz_grades IS
...
COMMENT ON VIEW api.quiz_grade_events IS
...
COMMENT ON VIEW api.quiz_grade_exceptions IS
...
COMMENT ON VIEW api.ui_elements IS
...
COMMENT ON VIEW api.user_secrets IS
...
COMMENT ON VIEW api.user_jwts IS

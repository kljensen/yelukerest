...
--
-- Name: sign_mcp_user_jwt(integer, data.user_role, text, text, text); Type: FUNCTION; Schema: auth; Owner: superuser
--
...
--
-- Name: prevent_mcp_jwt_mint_event_mutation(); Type: FUNCTION; Schema: data; Owner: superuser
--
...
ALTER FUNCTION data.prevent_mcp_jwt_mint_event_mutation() OWNER TO superuser;

--
-- Name: mcp_jwt_mint_event; Type: TABLE; Schema: data; Owner: superuser
--
...
ALTER TABLE data.mcp_jwt_mint_event OWNER TO superuser;

--
-- Name: mcp_jwt_mint_event_id_seq; Type: SEQUENCE; Schema: data; Owner: superuser
--
...
--
-- Name: mcp_jwt_mint_event mcp_jwt_mint_event_pkey; Type: CONSTRAINT; Schema: data; Owner: superuser
--
...
--
-- Name: idx_mcp_jwt_mint_event_caller_window; Type: INDEX; Schema: data; Owner: superuser
--
...
--
-- Name: idx_mcp_jwt_mint_event_user_fk; Type: INDEX; Schema: data; Owner: superuser
--
...
--
-- Name: mcp_jwt_mint_event tg_mcp_jwt_mint_event_append_only; Type: TRIGGER; Schema: data; Owner: superuser
--
...
--
-- Name: mcp_jwt_mint_event; Type: ROW SECURITY; Schema: data; Owner: superuser
--

ALTER TABLE data.mcp_jwt_mint_event ENABLE ROW LEVEL SECURITY;

--
-- Name: mcp_jwt_mint_event mcp_jwt_mint_event_access_policy; Type: POLICY; Schema: data; Owner: superuser
--
...
--
-- Name: issue_user_jwt_for_mcp(text, text[], jsonb); Type: FUNCTION; Schema: api; Owner: superuser
--
...
ALTER FUNCTION api.issue_user_jwt_for_mcp(p_netid text, p_scopes text[], p_external jsonb) OWNER TO superuser;
...
--
-- Name: FUNCTION issue_user_jwt_for_mcp(p_netid text, p_scopes text[], p_external jsonb); Type: ACL; Schema: api; Owner: superuser
--
...
--
-- Name: FUNCTION sign_mcp_user_jwt(user_id integer, role data.user_role, netid text, scopes text, jti text); Type: ACL; Schema: auth; Owner: superuser
--
...
--
-- Name: TABLE mcp_jwt_mint_event; Type: ACL; Schema: data; Owner: superuser
--
...
-- Connected-application disconnects (issue #277). Appended by hand because

-- the generator cannot run on this machine (pg_dump 14 against an 18.4

-- server, and the Dockerised sqitch wants a TTY). Every statement below is

-- verbatim from pg_dump of a database built from db/src, so regenerating
...
ALTER FUNCTION data.mcp_grant_revocation_is_append_only() OWNER TO superuser;
...
ALTER TABLE data.mcp_grant_revocation OWNER TO superuser;
...
ALTER FUNCTION api.record_mcp_grant_revocation(netid text, client_id text, client_name text, scopes text) OWNER TO superuser;

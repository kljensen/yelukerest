...
env_vars='$NGINX_HTTP_DEV_INCLUDES$NGINX_SERVER_DEV_INCLUDES$FQDN$NAKED_FQDN$OPENRESTY_DEVELOPMENT$OPENRESTY_CACHE_BYPASS$REDIS_PASSWORD$OPENRESTY_SESSION_SECRET'
